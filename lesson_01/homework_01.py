...
print(f"apple_tree = {apple_tree}, pear_tree = {pear_tree}, plum_tree = {plum_tree}")
...
boys_total = 24
girls_total = boys_total // 2 # // ділення без остачі, бо діти - це цілі числа
boys_today = boys_total - 1
girls_today = girls_total - 2
children_today = boys_today + girls_today
print(f"Total children today: {children_today}")
...
print(f"first_book = {first_book}, second_book = {second_book}, third_book = {third_book}")
